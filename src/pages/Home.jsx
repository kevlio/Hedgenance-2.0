        ...
        <Container maxW={"3xl"}>
          <Stack as={Box} textAlign={"center"} spacing={{ base: 4, md: 6 }}>
            ...
            <Box color={"white"}>
              ...
              Hedgehog Communitas we protect you from snowballing economies and
              blind folded central banks. Ernest Hemingway answered the
              question: How did you go bankrupt? with these words: {""} <br />
              <Text
                fontWeight={600}
                as={"span"}
                color={"green.400"}
